...
public interface ProductRepository {
	 ...
	 * 상품을 추가한다
	 * @param product 상품
	 * @throws AddException 상품번호가 중복될 경우 "이미 존재하는 상품입니다" 상세메세지를 갖는 예외가 발생한다.
	 */
	public void insert(Product product) throws AddException ; //interface이기 때문에 앞에 abstract가 생략되어있음
	// JAVA에서 제공하는 예외가 아닌 사용자 정의 예외이기 때문에 에러 발생 -> 예외에 대한 Class 가지고 있어야 함
